...
const Product = () => { 
  ...
  const { cartItems , token } = useSelector((state) => state.products)
  ...
  const addToCart = async () => {
    ...
    const response = await axios.post(backendUrl + '/api/cart/add', {productData , size }  , {headers : {token}} )
    ...
    <div className='border-t-2 pt-10 transition-opacity ease-in duration-500 opacity=100'>
      ...
      <div className='flex gap-12 sm:gap-12 flex-col sm:flex-row '>
        ...
        <div className='flex-1'>
          ...
          <button onClick={addToCart} className='bg-black text-white px-8 py-3 text-sm active:bg-gray-700 rounded ' >Add to Cart</button>
